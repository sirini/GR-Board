...
<head>
<meta charset="utf-8" />
<title>GR Board Upgrade: v1.7.7 "바다표범 II" ▶▶▶ 페어리 펭귄 (v1.9.4 BETA) 으로 업데이트 되었습니다.</title>
</head>
<body>

<h2>GR Board 페어리 펭귄의 업데이트가 완료 되었습니다!</h2>

<strong>DB Table 업데이트 내역</strong>
<ul>
	<li><em>관리화면에서 글 관리 페이지의 테마를 선택할 수 있도록 gr_layout_config 에 article_adjust 항목이 추가되었습니다.</em></li>
	<li>패스워드 저장 길이를 md5 해시길이에 맞게 수정하였습니다. (gr_member_list 의 password 컬럼)</li>
